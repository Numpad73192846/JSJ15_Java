...
import day04.Ex01_Class.Person;
import day05.Ex01_Inheritance.Pikachu;
import day05.Ex01_Inheritance.Raichu;
...
public class Main {
    public static void main(String[] args) {
        ...
        Pikachu pokachu = new Raichu();
        
        System.out.println(pokachu instanceof Pikachu);
        System.out.println(pokachu instanceof Raichu);
        
        if( pokachu instanceof Raichu ) {}
        if( pokachu instanceof Pikachu ) {}
