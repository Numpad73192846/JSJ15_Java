...
public class ChatServer {
	...
	private static List<PrintWriter> clinetWriterList = new CopyOnWriteArrayList<>();
	...
	public static void broadcast(String message, PrintWriter sender) {
		...
		for (PrintWriter writer : clinetWriterList) {
			if( writer != sender ) {
	...
	static class ClientHandler implements Runnable {
		...
		public void run() {
			try {
				...
				try {
					if(out != null ) clinetWriterList.remove(out);
					if( clientName != null ) {
